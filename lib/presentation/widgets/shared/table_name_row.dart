...
class TableNameRow extends StatefulWidget {
  ...
  @override
  State<TableNameRow> createState() => _TableNameRowState();
}
...
class _TableNameRowState extends State<TableNameRow> {
  ...
  void initState() {
    ...
    _ctrl = TextEditingController(
      text: context.read<OrderCubit>().state.getTableName(widget.tableNumber),
    );
  }
  ...
  Widget build(BuildContext context) {
    final name = context.watch<OrderCubit>().state.getTableName(
      widget.tableNumber,
    );
      ...
      child: ListTile(
        ...
        title: _editing
            ? TextField(
                ...
                onSubmitted: (v) {
                  context.read<OrderCubit>().setTableName(
                    widget.tableNumber,
                    v,
                  );
