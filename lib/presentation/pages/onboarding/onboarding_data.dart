...
enum OnbPage {
  ...
  List<Color> get gradient => switch (this) {
        ...
        management => const [Color(0xFF8B5CF6), Color(0xFFD946EF), Color(0xFFEC4899)],
      };
  ...
  IconData get icon => switch (this) {
        ...
        management => Icons.admin_panel_settings_rounded,
      };
  ...
  String get titleKey => switch (this) {
        ...
        management => 'onboarding_mgmt_title',
      };
  ...
  String get descKey => switch (this) {
        ...
        management => 'onboarding_mgmt_desc',
      };
  ...
  List<String> get featureKeys => switch (this) {
        ...
        management => ['onboarding_feat_roles', 'onboarding_feat_food_mgmt', 'onboarding_feat_table_mgmt', 'onboarding_feat_categories_mgmt', 'onboarding_feat_printing'],
      };
}
