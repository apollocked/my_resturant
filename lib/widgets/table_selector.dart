    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          Text(selectedTable == 0 ? 'هەڵبژێرە' : 'مێز $selectedTable',
        ...
        Wrap(spacing: 10, runSpacing: 10, children: List.generate(20, (i) {
          ...
          return SizedBox(width: 56, height: 44, child: OutlinedButton(
            ...
            style: OutlinedButton.styleFrom(
              backgroundColor: locked ? const Color(0xFFE0E0E0) : (sel ? AppTheme.primary : Colors.white),
              foregroundColor: locked ? const Color(0xFF999999) : (sel ? Colors.white : AppTheme.textPrimary),
              side: BorderSide(color: locked ? const Color(0xFFD0D0D0) : (sel ? AppTheme.primary : const Color(0xFFE0DCD8))),
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),
            child: locked
                ? const Icon(Icons.lock, size: 14, color: Color(0xFF999999))
