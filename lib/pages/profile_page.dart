...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(child: Padding(padding: const EdgeInsets.all(20), child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
      ...
      _card(context, Icons.restaurant_menu, 'خواردنەکان', 'بینین و بەردەستکردنی خواردنەکان', const FoodManagementPage()),
      ...
      SizedBox(width: double.infinity, child: OutlinedButton(
        ...
        style: OutlinedButton.styleFrom(foregroundColor: AppTheme.error,
          side: const BorderSide(color: AppTheme.error), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))),
        child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Icon(Icons.logout, size: 18), SizedBox(width: 8), Text('چوونەدەرەوە'),
        ]))),
      const SizedBox(height: 10),
    ]));
  }
